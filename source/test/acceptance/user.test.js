...
describe('POST /user', function () {
  ...
  var tests = [
    { data: { appid: '', username: randomuser, password: 'abcdefg', email: randommail},
      status: 400, desc : 'Invalid app Id',
      JSchema :  schema.error,
      JValues: {'id': 'INVALID_APPID' } },

    { data: { appid: 'pryv-test', username: 'wa', password: 'abcdefg', email: randommail},
      status: 400, desc : 'Invalid user',
      JSchema :  schema.error,
      JValues: {'id': 'INVALID_USER_NAME' } },

    { data: {  appid: 'pryv-test', username: 'pryvwa', password: 'abcdefg', email: randommail},
      status: 400, desc : 'Invalid user',
      JSchema :  schema.error,
      JValues: {'id': 'RESERVED_USER_NAME' } },

    { data: {  appid: 'pryv-test', username: randomuser, password: 'abcdefg', email: 'assa'},
      status: 400, desc : 'Invalid user',
      JSchema :  schema.error,
      JValues: {'id': 'INVALID_EMAIL' } },

    { data: {  appid: 'pryv-test', username: 'wactiv', password: 'abcdefg', email: randommail},
      status: 400, desc : 'Existing user',
      JSchema :  schema.multipleErrors,
      JValues: { 'id': 'INVALID_DATA',
        'errors': [ {'id': 'EXISTING_USER_NAME' } ]   }},

    { data: {  appid: 'pryv-test', username: randomuser, password: 'abcdefg', email: 'wactiv@pryv.io'},
      status: 400, desc : 'Existing e-mail',
      JSchema :  schema.multipleErrors,
      JValues: {'id' : 'INVALID_DATA',
        'errors': [ {'id': 'EXISTING_EMAIL' } ]   }},

    { data: {  appid: 'pryv-test', username: 'wactiv', password: 'abcdefg', email: 'wactiv@pryv.io'},
